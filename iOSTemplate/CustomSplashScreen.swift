...
class CustomSplashScreen: UIView {
  ...
  override init(frame: CGRect) {
    ...
    self.splashImageView = UIImageView(frame: CGRect(x: (self.frame.height)/2 - 150, y: (self.frame.height)/2 - 60, width: 290, height: 116))
  ...
  func setupAnimation() {
    ...
    for index in 1...31 {
      let img = UIImage(named: "NLL_Loading_Animation_\(index).png")
      imgArray.append(img!)
    }
  ...
  func setupConstraints() {
    ...
    self.splashImageView.addConstraint(NSLayoutConstraint(item: self.splashImageView, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.lessThanOrEqual, toItem: nil, attribute: NSLayoutAttribute.width, multiplier: 1, constant: 290))
    self.splashImageView.addConstraint(NSLayoutConstraint(item: self.splashImageView, attribute: NSLayoutAttribute.height, relatedBy: NSLayoutRelation.lessThanOrEqual, toItem: nil, attribute: NSLayoutAttribute.height, multiplier: 1, constant: 116))
  }
}
